...
TEST(WorkerTest, HasBuffer)
{
    ...
    std::cout << "TESTED WorkTest HasBuffer!" << std::endl;
}
...
TEST(RampTest, IsDeliveryOnTime)
{
    ...
    r.deliver_goods(3);
    ASSERT_TRUE(r.get_sending_buffer().has_value());
    std::cout << "TESTED RampTest IsDeliveryOnTime!" << std::endl;
}
...
TEST(ReceiverPreferencesTest, AddReceiversRescalesProbability)
{
    ...
    std::cout << "TESTED ReceicerPreferences AddReceiversRescales!" << std::endl;
}
...
TEST(ReceiverPreferencesTest, RemoveReceiversRescalesProbability)
{
    ...
    EXPECT_EQ(rp.get_preferences().at(&r1), 1.0);
    std::cout << "TESTED ReceicerPreferences RemoveReceiversRescalesProbabil!" << std::endl;
}
...
TEST_F(ReceiverPreferencesChoosingTest, ChooseReceiver)
{
    ...
    ReceiverPreferences rp;
    std::cout << probability_generator() << std::endl;
    ...
    std::cout << "TESTED ReceicerPreferencesChoosing " << std::endl;
}
